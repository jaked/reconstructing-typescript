...
export const isSubtype = Trace.instrument("isSubtype", function isSubtype2(a, b) {
  ...
  if (Type.isIntersection(a)) return a.types.some(a2 => isSubtype2(a2, b));
  if (Type.isIntersection(b)) return b.types.every(b2 => isSubtype2(a, b2));
